<div class="max-w-[1100px] mx-auto px-4 sm:px-6 py-6 pb-24 sm:pb-6 flex flex-col gap-5">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-9">
        ...
        <div x-data="{ zoomed: false }">
            <div @if($product->photo_path) @click="zoomed = true" @endif
                @class(['bg-surface border border-border rounded-2xl shadow-sm p-6 sm:p-10 flex items-center justify-center aspect-square', 'cursor-zoom-in' => $product->photo_path])>
